...
public class Staff {
    ...
    private String staffTypeId;//Staff type id
    ...
    private float salPerMonth;
    private String status="F";//First Time Login
    ...
    public float getSalPerMonth() {
        return salPerMonth;
    }

    public void setSalPerMonth(float salPerMonth) {
